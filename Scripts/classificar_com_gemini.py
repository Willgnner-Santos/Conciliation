...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = (
    r"C:\Users\anonymous\Documents\Modelos\Perfil-Conciliação-Xgboost-GCP\scripts"
...
# —————————————————————————————————————————————————
caminho_json = (
    r"C:\Users\anonymous\Documents\Modelos\Perfil-Conciliação-Xgboost-GCP"
    r"\dados\Embeddings\dados_processos_anonymous_embeddeds.json"
)
